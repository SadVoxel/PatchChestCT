...
class CTReportDatasetTrain(data.PersistentDataset):
    def __init__(self, data_folder, csv_file, min_slices=20, resize_dim=500, force_num_frames=True, labels = "labels.csv"):
        ...
        self.pad_or_crop = transforms.ResizeWithPadOrCrop(spatial_size=(120, 240, 240))
    ...
    def nii_img_to_tensor(self, path, annotations_mask):
        ...
        volume = self.random_crop(volume)
...
if __name__ == "__main__":
    ...
    csv_file = "train_reports.csv"
    labels = "dataset_multi_abnormality_labels_train_predicted_labels.csv"
